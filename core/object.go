//go:generate go run gen/gen_types.go assert Comparable *Vector Char String Symbol Keyword Regex Boolean Time Number Seqable Callable *Type Meta Int Double Stack Map Set Associative Reversible Named Comparator *Ratio *Namespace *Var *GoVar Error *Fn Deref *Atom Ref KVReduce Pending GoObject *File io.Reader io.Writer StringReader io.RuneReader *GoType *Future
