...
var atoi_ Proc = Proc{Fn: __atoi__P, Name: "atoi_", Package: "std/joker.strconv"}
...
var iscan_backquote_ Proc = Proc{Fn: __iscan_backquote__P, Name: "iscan_backquote_", Package: "std/joker.strconv"}
...
var format_bool_ Proc = Proc{Fn: __format_bool__P, Name: "format_bool_", Package: "std/joker.strconv"}
...
var format_double_ Proc = Proc{Fn: __format_double__P, Name: "format_double_", Package: "std/joker.strconv"}
...
var format_int_ Proc = Proc{Fn: __format_int__P, Name: "format_int_", Package: "std/joker.strconv"}
...
var isgraphic_ Proc = Proc{Fn: __isgraphic__P, Name: "isgraphic_", Package: "std/joker.strconv"}
...
var itoa_ Proc = Proc{Fn: __itoa__P, Name: "itoa_", Package: "std/joker.strconv"}
...
var parse_bool_ Proc = Proc{Fn: __parse_bool__P, Name: "parse_bool_", Package: "std/joker.strconv"}
...
var parse_double_ Proc = Proc{Fn: __parse_double__P, Name: "parse_double_", Package: "std/joker.strconv"}
...
var parse_int_ Proc = Proc{Fn: __parse_int__P, Name: "parse_int_", Package: "std/joker.strconv"}
...
var isprintable_ Proc = Proc{Fn: __isprintable__P, Name: "isprintable_", Package: "std/joker.strconv"}
...
var quote_ Proc = Proc{Fn: __quote__P, Name: "quote_", Package: "std/joker.strconv"}
...
var quote_char_ Proc = Proc{Fn: __quote_char__P, Name: "quote_char_", Package: "std/joker.strconv"}
...
var quote_char_to_ascii_ Proc = Proc{Fn: __quote_char_to_ascii__P, Name: "quote_char_to_ascii_", Package: "std/joker.strconv"}
...
var quote_char_to_graphic_ Proc = Proc{Fn: __quote_char_to_graphic__P, Name: "quote_char_to_graphic_", Package: "std/joker.strconv"}
...
var quote_to_ascii_ Proc = Proc{Fn: __quote_to_ascii__P, Name: "quote_to_ascii_", Package: "std/joker.strconv"}
...
var quote_to_graphic_ Proc = Proc{Fn: __quote_to_graphic__P, Name: "quote_to_graphic_", Package: "std/joker.strconv"}
...
var unquote_ Proc = Proc{Fn: __unquote__P, Name: "unquote_", Package: "std/joker.strconv"}
